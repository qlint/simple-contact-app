         ...
         <main class="wrapperMain" role="main">
            <div class="">
               <aside class="navSidebar">
                  <nav class="navProperty">
                     <h1 class="navProperty-title"><a href="#" class="">{{ $data4page->group }}</a></h1>
            ...
            <div class="content content--withSidebar">
               <div class="hero hero--episodeHome ">
                     <h1>Added Successfully. Listed in - {{ $data4page->group }}</h1>
                     <br><br>
                     <h1>{{ $data4page->fname }} {{ $data4page->lname }}</h1>
                     <hr>
                     <br>
                     <h2>{{ $data4page->phone }}</h2>
                     <hr>
                     <br>
                     <h2><a href="mailto:{{ $data4page->email }}">{{ $data4page->email }}</a></h2>
                  
                     
                        <div class="pageTitle pageTitle--sub pageTitle--divider">
                           <h3 class="pageTitle-title">Send Mail to {{ $data4page->fname }} {{ $data4page->lname }}</h3>
                        </div>
