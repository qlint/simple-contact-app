...
<html class="" lang="en" data-react-checksum="1597088522">
   <head>
      ...
      <title>Contact App | <?php echo $__env->yieldContent('title'); ?></title>
   </head>
   <body class="template-commonTemplates-Homepage">
      ...
      <header class="headerMain">
         ...
         <div class="headerMain-wrapper">
            <div class="headerMain-logo">
               <a href="<?php echo e(route('home')); ?>" class="headerMain-logoLink">Contact App</a>
      ...
      <script src="<?php echo e(URL::asset('js/appgnyce.js')); ?>" async></script>
